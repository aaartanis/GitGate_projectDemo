...
void ana2_FLC()
{
    ...
    Double_t event_numb[2]={10031189,19198730};

   

    ofstream dataFile;
    dataFile.open("dataFile_FLC.txt",ofstream::app);
    ...
    for(int i=0;i<16;i++) //i<16 change i<1
    {
        ...
        pic_name.Form("/home/rocky/software/GitGate_projectDemo/MLC_verify/result/dose_equ_FLC/%s%s",recep_id[i].c_str(),format.Data());
