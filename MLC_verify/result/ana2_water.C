...
void ana2_water()
{
    ...
    Double_t event_numb[1]={10031509};

   

    ofstream dataFile;
    dataFile.open("dataFile_water.txt",ofstream::app);
    ...
    for(int i=0;i<5;i++) //i<16 change i<1
    {
        ...
        pic_name.Form("/home/rocky/software/GitGate_projectDemo/MLC_verify/result/dose_equ_water/%s%s",recep_id[i].c_str(),format.Data());
