...
void ana2_source()
{
    ...
    for(int i=0;i<5;i++) //i<16 change i<1
    {
        ...
        pic_name.Form("/home/rocky/software/GitGate_projectDemo/MLC_verify/result/dose_equ_source/%s%s",recep_id[i].c_str(),format.Data());
