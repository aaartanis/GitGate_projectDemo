...
{    
    ...
    for(Int_t i=0;i<16;i++)
    {
        ...
        for(Int_t j=0;j<6;j++)
        {
            ...
            file_name.Form("%d-202107140851/%d_receptor.root",a[j],b[i]);
        ...
        pic_name.Form("/home/rocky/software/GitGate_projectDemo/RF_iso/result/fluence/%s%s",recep_id[i].c_str(),format.Data());
