// Mainframe macro generated from application: /home/rocky/ROOT/root/bin/root.exe
// By ROOT version 6.20/04 on 2022-03-29 19:28:56
...
void miniStyle_Modern()
{
   ...
   tmpStyle->SetLabelFont(22, "x");
   tmpStyle->SetLabelFont(22, "y");
   tmpStyle->SetLabelFont(22, "z");
   ...
   tmpStyle->SetTitleOffset(1.2, "x");
   tmpStyle->SetTitleOffset(1.2, "y");
   tmpStyle->SetTitleOffset(1.2, "z");
   ...
   tmpStyle->SetTitleFont(22, "x");
   tmpStyle->SetTitleFont(22, "y");
   tmpStyle->SetTitleFont(22, "z");
