...
void d_HperD1()
{
    ...
    TCanvas *c1=new TCanvas("c1","c1",2);
    c1->cd();
    ...
    ipt->Draw("((EQ1+EQ2)*1e-9/(D_p*rbe))/79.870180:location","energy==400 && (location==0 ||( location>=1 && location<=5))","goff");
    ...
    ipt->Draw("((EQ1+EQ2)*1e-9/(D_p*rbe))/47.038287:location","energy==350 && (location==0 ||( location>=1 && location<=5))","goff");
    ...
    ipt->Draw("((EQ1+EQ2)*1e-9/(D_p*rbe))/24.625802:location","energy==300 && (location==0 ||( location>=1 && location<=5))","goff");
    ...
    ipt->Draw("((EQ1+EQ2)*1e-9/(D_p*rbe))/11.649179:location","energy==250 && (location==0 ||( location>=1 && location<=5))","goff");
    ...
    ipt->Draw("((EQ1+EQ2)*1e-9/(D_p*rbe))/4.6997141:location","energy==200 && (location==0 ||( location>=1 && location<=5))","goff");
    ...
    ipt->Draw("((EQ1+EQ2)*1e-9/(D_p*rbe))/2.1156558:location","energy==165 && (location==0 ||( location>=1 && location<=5))","goff");
