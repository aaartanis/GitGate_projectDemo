...
# 如果有其他变量的话增加循环的层数即可，增加
	...
	sed -i  "/\/openhole\/geometry\/setXLength/s/90/$i/" mac/HIMM_room2.mac
	#改变HIMM_room2.mac的开口大小，使用$i代替90
	sed -i  "/\/openhole\/geometry\/setYLength/s/90/$i/" mac/HIMM_room2.mac
